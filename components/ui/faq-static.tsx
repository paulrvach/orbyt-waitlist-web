          ...
          <div className="divide-y divide-dashed sm:mx-auto sm:max-w-lg lg:mx-0">
            ...
            <div className="py-6">
              ...
              <p className="text-muted-foreground mt-4">
                ...
                account and clicking on the cancel button.
              </p>
            </div>
            <div className="py-6">
              ...
              <ul className="list-outside list-disc space-y-2 pl-4">
                <li className="text-muted-foreground">
                  You will be charged the difference in price between your current
                  plan and the plan you are upgrading to.
                </li>
                <li className="text-muted-foreground">
                  Your new plan will take effect immediately and you will be billed
                  at the new rate on your next billing cycle.
                </li>
              </ul>
            </div>
            <div className="py-6">
              ...
              <p className="text-muted-foreground mt-4">
                ...
                contact us via email or live chat for any questions or concerns you
                may have.
              </p>
            </div>
          </div>
